...
AFRAME.registerComponent("markerhandler", {
  ...
  handleOrderSummary: async function () {
    ...
    td_1.setAttribute("class", "no-line text-center");
    var td_2 = document.createElement("td");
    td_2.setAttribute("class", "no-line text-center");

    var str_element = document.createElement("strong");
    var td_3 = document.createElement("td");
    td_3.setAttribute("class", "no-line text-center");

    str_element.innerHTML = "Total ";

    td_3.appendChild(str_element);

    td_4 = document.createElement("td");
    td_4.setAttribute("class", "no-line text-right");

    td_4.innerHTML="Rs. " + orderSummary.total_bill;

    total.appendChild(td_1);
    total.appendChild(td_2);
    total.appendChild(td_3);
    total.appendChild(td_4);

    tableBodyTag.appendChild(total);
  },
  handlePayment: function () {

    var modal_vis = document.getElementById("modal-div");
    modal_vis.style.display = "none";
